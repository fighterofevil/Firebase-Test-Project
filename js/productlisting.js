...
// 	var loggedIn = '<li><p class="navbar-text navbar-right">' + authData.password.email +'</p></li>';
// 	loggedIn+= '<li><button type="button" class="btn btn-warning navbar-btn" id="logoutButton"></button></li>';
